...
class SimpleController:
    def __init__(self):
        ...
        # Publisher untuk cmd_vel (kita test dengan teleop dulu)
        ...
        # Test: kirim perintah maju secara periodic
        self.timer = rospy.Timer(rospy.Duration(0.1), self.send_cmd)
        
    def send_cmd(self, event):
        # Test dengan perintah maju
        cmd_msg = Twist()
        cmd_msg.linear.x = 0.1  # Maju perlahan
